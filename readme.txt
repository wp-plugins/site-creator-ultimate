...
to use only layout 1 we can use the short code

[sitecreator show="1"]

if we want o use layout 1, 2 and 3 we can use we can use the short codes
...
2. Change the layout to your liking by adding title, excerpt and changing image size etc. Important: Make sure that the image and the post fits into your sidebar!
